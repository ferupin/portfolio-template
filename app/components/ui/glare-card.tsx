...
export const GlareCard = ({
  ...
  const containerStyle = {
    ...
    '--foil-size': '100%',
    '--opacity': '0',
    '--radius': '50%', // Updated to match rounded-full
    '--easing': 'ease',
  ...
  return (
    <div
      ...
      className="relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[350px] h-[350px]" // Updated dimensions
      ref={refElement}
      onPointerMove={event => {
